...
#include "UVRPProjectile.generated.h"

UCLASS(config=Game)
class AUVRPProjectile : public AActor
{
	GENERATED_BODY()
	...
	UPROPERTY(VisibleDefaultsOnly, Category = Projectile)
	class UParticleSystemComponent* psTrail;
...
public:
	...
	void SetBulletTrailVisibility(bool IsVisible);
